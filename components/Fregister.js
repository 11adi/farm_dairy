...
import '../components/Fregister.css';
export class Fregister extends Component{
  constructor(props) {
    super(props)
...
render(){
  return (
    ...
    <div className="text-block-8">
          <input type="text" placeholder="Udyog Aadhar" className="bg-[#ffffff] text-black w-80 text-center px-38 py-2" value={this.state.IuniqueId} onChange={this.handleIuniqueIdchange} ></input>
    </div>
